...
import { NEON, CLASSES, POTIONS, GEMS } from "./data";
import {
  getDirectKills,
  makeFloorObjective,
...
import { generateLevel } from "./dungeonGenerator";
import {
  applyDefensiveEffects as _applyDefensiveEffects,
  applyTerrainToMonster as _applyTerrainToMonster,
  handleSpawnEffect as _handleSpawnEffect,
} from "./combatHelpers";
import {
  GRID_WIDTH,
  GRID_HEIGHT,
...
function DownwardsNeon() {
  ...
  const applyTerrainToMonster = useCallback(
    (monster, currentMap) => _applyTerrainToMonster(monster, currentMap),
    []
  );
  ...
  const applyDefensiveEffects = _applyDefensiveEffects;
  const handleSpawnEffect = _handleSpawnEffect;
  ...
  const enterSurfaceDefense = useCallback(
    ...
    [getSurfaceCorruptionStage, showMessage]
  );
