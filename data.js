...
export const WEAPONS = {
  1: [
    { names: ["Spectrum Rubber Key", "Frayed Cassette Ribbon"], dmg: [2, 4], short: ["KEY ", "TAPE"], chance: 60, family: "NONE" },
    { names: ["Broken MSX Cartridge", "Amstrad Volume Knob"], dmg: [3, 5], short: ["CART", "KNOB"], chance: 40, family: "CRIT" },
  ],
  2: [
    { names: ["Broken MSX Cartridge", "Amstrad Volume Knob"], dmg: [3, 5], short: ["CART", "KNOB"], chance: 35, family: "CRIT" },
    { names: ["Kempston Joystick", "Amstrad JY-2"], dmg: [4, 6], short: ["JOY ", "JY-2"], chance: 40, family: "NONE" },
    { names: ["ZX Microdrive", "MSX Data Recorder"], dmg: [5, 7], short: ["DRVE", "RECR"], chance: 20, family: "KNOCKBACK" },
    { names: ["Aztec C Compiler", "Sinclair ZX Printer"], dmg: [6, 8], short: ["COMP", "PRNT"], chance: 5, family: "CRIT" },
  ],
  3: [
    { names: ["Z80 RAM Stick", "AY-3-8912 Chip"], dmg: [5, 7], short: ["RAM ", "CHIP"], chance: 30, family: "NONE" },
    { names: ["Amstrad 3-inch Disk", "MSX Floppy Shard"], dmg: [6, 9], short: ["DISK", "FLOP"], chance: 35, family: "NONE" },
    { names: ["Sinclair Power Brick", "CPC Monitor Brick"], dmg: [7, 10], short: ["BRCK", "MNTR"], chance: 25, family: "KNOCKBACK" },
    { names: ["Spectrum Edge Connector", "MSX Slot Cleaner"], dmg: [8, 12], short: ["CONN", "SLOT"], chance: 10, family: "NONE" },
  ],
  4: [
    { names: ["Amstrad 3-inch Disk", "MSX Floppy Shard"], dmg: [7, 10], short: ["DISK", "FLOP"], chance: 25, family: "NONE" },
    { names: ["Centronics Cable", "ZX Interface 1 Cable"], dmg: [8, 12], short: ["CABL", "INTF"], chance: 40, family: "NONE" },
    { names: ["Tape Splicer", "Data Shredder"], dmg: [9, 14], short: ["SPLC", "SHRD"], chance: 25, family: "CLEAVE" },
    { names: ["Multiface Two", "MSX Expansion Cartridge"], dmg: [11, 16], short: ["MLT2", "EXPN"], chance: 10, family: "NONE" },
  ],
  5: [
    { names: ["Centronics Cable", "ZX Interface 1 Cable"], dmg: [9, 13], short: ["CABL", "INTF"], chance: 25, family: "NONE" },
    { names: ["Data Shredder", "Locomotive Smasher"], dmg: [11, 16], short: ["SHRD", "SMAS"], chance: 35, family: "CLEAVE" },
    { names: ["RS232 Whip", "Amstrad Joystick Cord"], dmg: [12, 18], short: ["WHIP", "CORD"], chance: 25, family: "REACH" },
    { names: ["Multiface One", "Poke Finder"], dmg: [14, 20], short: ["MLT1", "POKE"], chance: 15, family: "ARCANE" },
  ],
  6: [
    { names: ["Locomotive Smasher", "Z80 Bus Terminator"], dmg: [12, 18], short: ["SMAS", "TERM"], chance: 25, family: "CLEAVE" },
    { names: ["RS232 Whip", "VDP Display Cord"], dmg: [14, 22], short: ["WHIP", "VDP "], chance: 35, family: "REACH" },
    { names: ["Z80 Hex Injector", "Assembly Blade"], dmg: [16, 24], short: ["INJT", "BLAD"], chance: 25, family: "ARCANE" },
    { names: ["AMSDOS FastLoad", "MSX-DOS Boot Disk"], dmg: [18, 28], short: ["FAST", "BOOT"], chance: 15, family: "ARCANE" },
  ],
  7: [
    { names: ["VDP Display Cord", "Spectrum RGB Scart"], dmg: [16, 24], short: ["VDP ", "RGB "], chance: 25, family: "REACH" },
    { names: ["Assembly Blade", "Z80 Machine Code"], dmg: [18, 28], short: ["BLAD", "MACH"], chance: 35, family: "ARCANE" },
    { names: ["Sinclair BASIC Smasher", "Z80 Decompiler"], dmg: [20, 32], short: ["BASC", "DCMP"], chance: 25, family: "CLEAVE" },
    { names: ["TMS9918 Video Engine", "Holy Z80 Processor"], dmg: [24, 36], short: ["VID ", "CPU "], chance: 15, family: "ARCANE" },
  ],
  8: [
    { names: ["Z80 Machine Code", "MSX BIOS Rootkit"], dmg: [20, 30], short: ["MACH", "ROOT"], chance: 25, family: "ARCANE" },
    { names: ["Locomotive Crusher", "AMSDOS Kernel Smasher"], dmg: [24, 38], short: ["CRSH", "KRNL"], chance: 35, family: "CLEAVE" },
    { names: ["Holy Z80 Processor", "AY-3 Masterpiece"], dmg: [28, 42], short: ["CPU ", "AY-3"], chance: 25, family: "ARCANE" },
    { names: ["The Z80 Source Code", "Sinclair Admin Rights"], dmg: [35, 50], short: ["SRCE", "ADMN"], chance: 15, family: "ARCANE" },
  ],
};
